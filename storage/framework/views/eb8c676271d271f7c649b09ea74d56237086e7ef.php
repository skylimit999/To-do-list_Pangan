...
<div class="w-100 h-100 d-flex justify-content-center align-items-center">
    <div class="text-center" style="width: 100vh; background-color: rgba(254,245,245,0.5);">
        <h1 class="display-1 text-black">Todo List App</h1>
        <h2 class="text-black pt-4 text-left">Your Task Today</h2>
        ...
        <h2 class="text-black pt-4 text-center"> My To Do List </h2>
        <div class=" w-100" style="background-color:blanchedalmond;">
            ...
            <div class="w-100 d-flex align-items-center justify-content-between"> 
                ...
                <div class="mr-4 d-flex align-items-center">
                    ...
                    <form action="<?php echo e(route('todo.update' , $todo->id)); ?>" method="POST">
                        ...
                        <button class="btn text-black" style="background-color: darkcyan;">&ensp; Marked &ensp;</button>
                    </form>
                    ...
                    <form action="<?php echo e(route('todo.update' , $todo->id)); ?>" method="POST">
                        ...
                        <button class="btn text-black" style="background-color: darkgoldenrod;" >Completed</button>
            ...
            <p class="text-center text-black ml-5 pt-3 pb-3 font-italic"> No task today. </p>
            <?php endif; ?>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel-breeze\todo-list\resources\views/welcome.blade.php ENDPATH**/ ?>